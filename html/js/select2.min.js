...
*/
(function (e) {
  "undefined" == typeof e.fn.each2 &&
    e.fn.extend({
      each2: function (g) {
        for (
          var i = e([0]), m = -1, s = this.length;
          ++m < s && (i.context = i[0] = this[m]) && !1 !== g.call(i[0], m, i);
...
(function (e, g) {
  ...
  function H(a, b, c, d) {
    var e = a,
      ...
      o;
    if (
      !d.createSearchChoice ||
      !d.tokenSeparators ||
      1 > d.tokenSeparators.length
    )
      return g;
    for (;;) {
      h = -1;
      k = 0;
      for (
        n = d.tokenSeparators.length;
        k < n && !((o = d.tokenSeparators[k]), (h = a.indexOf(o)), 0 <= h);
        k++
      );
      if (0 > h) break;
      f = a.substring(0, h);
  ...
  if (window.Select2 === g) {
    ...
    e(document).ready(function () {
      e(document).delegate("body", "mousedown touchend", function (a) {
        ...
        b = e(a.target);
        c = b.attr("for");
        "LABEL" === a.target.tagName &&
          c &&
          0 < c.length &&
          ((b = e("#" + c)),
          (b = b.data("select2")),
          b !== g && (b.focus(), a.preventDefault()));
      });
    });
    w = x(Object, {
      bind: function (a) {
      ...
      init: function (a) {
        ...
        this.id = a.id;
        a.element.data("select2") !== g &&
          null !== a.element.data("select2") &&
          this.destroy();
        this.enabled = !0;
        ...
        a.element.attr("class") !== g &&
          this.container.addClass(
            a.element.attr("class").replace(/validate\[[\S ]+] ?/, "")
          );
        ...
        e.fn.mousewheel &&
          b.mousewheel(function (a, c, d, e) {
            c = b.scrollTop();
            0 < e && 0 >= c - e
              ? (b.scrollTop(0), l(a))
              : 0 > e &&
                b.get(0).scrollHeight - b.scrollTop() + e <= b.height() &&
                (b.scrollTop(b.get(0).scrollHeight - b.height()), l(a));
          });
        c.bind("keydown", function () {
          e.data(c, "keyup-change-value") === g &&
            e.data(c, "keyup-change-value", c.val());
        });
        c.bind("keyup", function () {
          var a = e.data(c, "keyup-change-value");
          a !== g &&
            c.val() !== a &&
            (e.removeData(c, "keyup-change-value"), c.trigger("keyup-change"));
        });
        ...
        this.dropdown.delegate(
          ...
          this.bind(function (a) {
            ...
            e(a.target).closest(
              ...
              ? (this.highlightUnderEvent(a), this.selectHighlighted(a))
              : this.focusSearch();
            l(a);
          })
        );
        ...
        (a.element.is(":disabled") || a.element.is("[readonly='readonly']")) &&
          this.disable();
      },
      destroy: function () {
      ...
      prepareOpts: function (a) {
        var b, c, d;
        b = a.element;
        "select" === b.get(0).tagName.toLowerCase() &&
          (this.select = c = a.element);
        c &&
          e.each(
            "id multiple ajax query createSearchChoice initSelection data tags".split(
              " "
            ),
            function () {
              if (this in a)
        ...
        if ("function" !== typeof a.query)
          throw (
            "query function not defined for Select2 " + a.element.attr("id")
          );
        return a;
      },
      ...
      moveHighlight: function (a) {
        for (
          ...
          var c = c + a,
            d = e(b[c]);
          if (
            d.hasClass("select2-result-selectable") &&
      ...
      updateResults: function (a) {
        ...
        if (!(!0 !== a && (!1 === this.showSearchInput || !this.opened()))) {
          ...
          if (
            1 <= h.maximumSelectionSize &&
            ((i = this.data()),
            e.isArray(i) &&
              i.length >= h.maximumSelectionSize &&
              u(h.formatSelectionTooBig, "formatSelectionTooBig"))
          ) {
            c(
          ...
          d.val().length < h.minimumInputLength &&
          u(h.formatInputTooShort, "formatInputTooShort")
            ? c(
                "<li class='select2-no-results'>" +
                  h.formatInputTooShort(d.val(), h.minimumInputLength) +
                  "</li>"
              )
            : (c(
                "<li class='select2-searching'>" + h.formatSearching() + "</li>"
              ),
              (i = this.tokenize()),
              i != g && null != i && d.val(i),
              (this.resultsPage = 1),
              h.query({
                ...
                callback: this.bind(function (i) {
                  var l;
                  this.opened() &&
                    (((this.context = i.context === g ? null : i.context),
                    this.opts.createSearchChoice &&
                      "" !== d.val() &&
                      ((l = this.opts.createSearchChoice.call(
                        null,
                        d.val(),
                        i.results
                      )),
                      l !== g &&
                        ...
                        null !== k.id(l) &&
                        0 ===
                          e(i.results).filter(function () {
                            return m(k.id(this), k.id(l));
                          }).length &&
                        i.results.unshift(l)),
                    0 === i.results.length &&
                      u(h.formatNoMatches, "formatNoMatches"))
                      ? c(
                          "<li class='select2-no-results'>" +
                      ...
                      : (f.empty(),
                        ...
                        !0 === i.more &&
                          u(h.formatLoadMore, "formatLoadMore") &&
                          (f.append(
                            "<li class='select2-more-results'>" +
                              k.opts.escapeMarkup(
                                h.formatLoadMore(this.resultsPage)
                              ) +
                              "</li>"
                          ),
                          window.setTimeout(function () {
      ...
      selectHighlighted: function () {
        ...
        c &&
          (b.addClass("select2-disabled"), this.highlight(a), this.onSelect(c));
      },
    ...
    y = x(w, {
      createContainer: function () {
        return e("<div></div>", { class: "select2-container" }).html(
          "    <a href='#' onclick='return false;' class='select2-choice'>   <span></span><abbr class='select2-search-choice-close' style='display:none;'></abbr>   <div><b></b></div></a>    <div class='select2-drop select2-offscreen'>   <div class='select2-search'>       <input type='text' autocomplete='off' class='select2-input'/>   </div>   <ul class='select2-results'>   </ul></div>"
        );
      },
      opening: function () {
        this.search.show();
            ...
            if (this.enabled)
              if (a.which === f.PAGE_UP || a.which === f.PAGE_DOWN) l(a);
                ...
                a.which === f.TAB ||
                  ...
                  f.isFunctionKey(a) ||
                  a.which === f.ESC ||
                  (!1 === this.opts.openOnEnter && a.which === f.ENTER) ||
                  this.open();
          })
        );
        this.search.bind(
      ...
      initSelection: function () {
        if ("" === this.opts.element.val()) this.close(), this.setPlaceholder();
          ...
          this.opts.initSelection.call(null, this.opts.element, function (b) {
            b !== g &&
              null !== b &&
              (a.updateSelection(b), a.close(), a.setPlaceholder());
          });
        }
      },
      ...
      setPlaceholder: function () {
        ...
        "" === this.opts.element.val() &&
          a !== g &&
          !(this.select && "" !== this.select.find("option:first").text()) &&
      ...
      postprocessResults: function (a, b) {
        ...
        this.highlight(c);
        !0 === b &&
          ((f = this.showSearchInput =
            F(a.results) >= this.opts.minimumResultsForSearch),
          this.dropdown
            .find(".select2-search")
            [f ? "removeClass" : "addClass"]("select2-search-hidden"),
          e(this.dropdown, this.container)[f ? "addClass" : "removeClass"](
      ...
      data: function (a) {
        ...
        if (0 === arguments.length)
          return (
            (b = this.selection.data("select2-data")), b == g && (b = null), b
          );
        !a || "" === a
          ? this.clear()
    ...
    z = x(w, {
      createContainer: function () {
        return e("<div></div>", {
          ...
          "    <ul class='select2-choices'>  <li class='select2-search-field'>    <input type='text' autocomplete='off' class='select2-input'>  </li></ul><div class='select2-drop select2-drop-multi' style='display:none;'>   <ul class='select2-results'>   </ul></div>"
        );
      },
      prepareOpts: function () {
        var a = this.parent.prepareOpts.apply(this, arguments);
      ...
      initContainer: function () {
          ...
          this.bind(function (b) {
            if (this.enabled) {
              if (b.which === f.BACKSPACE && "" === this.search.val()) {
                ...
                a.find(".select2-search-choice-focus").removeClass(
              ...
              if (
                ...
                !(!1 === this.opts.openOnEnter && b.which === f.ENTER)
              )
                this.open(),
        ...
        this.container.delegate(
          ...
          this.bind(function (a) {
            this.enabled &&
              !(0 < e(a.target).closest(".select2-search-choice").length) &&
      ...
      tokenize: function () {
        ...
        null != a &&
          a != g &&
          (this.search.val(a), 0 < a.length && this.open());
      },
      onSelect: function (a) {
      ...
      addSelectedChoice: function (a) {
        ...
        b.find("div").replaceWith(
          "<div>" + this.opts.escapeMarkup(f) + "</div>"
        );
        b.find(".select2-search-choice-close")
          .bind("mousedown", l)
          .bind(
            "click dblclick",
            this.bind(function (a) {
      ...
      resizeSearch: function () {
        var a,
          ...
          c,
          d,
          f = this.search.outerWidth() - this.search.width();
        a = this.search;
        q ||
          ((c = a[0].currentStyle || window.getComputedStyle(a[0], null)),
          (q = e("<div></div>").css({
            position: "absolute",
            left: "-10000px",
            top: "-10000px",
      ...
      setVal: function (a) {
        ...
        this.select
          ...
          : ((b = []),
            ...
            this.opts.element.val(
              0 === b.length ? "" : b.join(this.opts.separator)
            ));
      },
      val: function () {
        var a,
    ...
    e.fn.select2 = function () {
      var a = Array.prototype.slice.call(arguments, 0),
        ...
        f,
        h =
          "val destroy opened open close focus isFocused container onSortStart onSortEnd enable disable positionDropdown data".split(
            " "
          );
      this.each(function () {
        if (0 === a.length || "object" === typeof a[0])
          (b = 0 === a.length ? {} : e.extend({}, a[0])),
            ...
            "select" === b.element.get(0).tagName.toLowerCase()
              ? (f = b.element.attr("multiple"))
              : ((f = b.multiple || !1), "tags" in b && (b.multiple = f = !0)),
            (c = f ? new z() : new y()),
            c.init(b);
