(function (m, oa) {
  ...
  function Yb(a, b, e) {
    ...
    function S(k) {
      if (j()) {
        ...
        k = new Date();
        k >= n.start && k < n.end
          ? C.disableButton("today")
          : C.enableButton("today");
        F--;
    ...
    function u() {
      o = b.contentHeight
        ? b.contentHeight
        : b.height
        ? b.height - (P ? P.height() : 0) - Sa(E)
        : Math.round(E.width() / Math.max(b.aspectRatio, 0.5));
    }
    function fa(k) {
      F++;
      n.setHeight(o, k);
  ...
  function Zb(a, b) {
    function e() {
      q = b.theme ? "ui" : "fc";
      if (b.header)
        return (Q = m("<div class='fc-header' style='width:100%'/>").append(
          m("<div>").append(f("left")).append(f("center")).append(f("right"))
        ));
    }
    function d() {
      Q.remove();
    ...
    function f(u) {
      ...
      (u = b.header[u]) &&
        m.each(u.split(" "), function (na) {
          na > 0 && fa.append("");
          var ga;
          m.each(this.split(","), function (ra, sa) {
            if (sa == "title") {
              fa.append(
                "<span class='fc-header-title'><strong>&nbsp;</strong></span>"
              );
              ...
              if (ha) {
                ...
                if (ma) {
                  ma.click(function () {
                    ...
                    .mousedown(function () {
                      ma.not("." + q + "-state-active")
                        .not("." + q + "-state-disabled")
                        .addClass(q + "-state-down");
                    })
                    .mouseup(function () {
                    ...
                    .hover(
                      function () {
                        ma.not("." + q + "-state-active")
                          .not("." + q + "-state-disabled")
                          .addClass(q + "-state-hover");
                      },
                      function () {
                        ma.removeClass(q + "-state-hover").removeClass(
                          q + "-state-down"
                        );
                      }
                    )
  ...
  function Fa(a, b, e) {
    for (
      b = b || 1;
      !a.getDay() || (e && a.getDay() == 1) || (!e && a.getDay() == 6);
  ...
  function gc(a) {
    return (
      (parseFloat(m.curCSS(a[0], "paddingLeft", true)) || 0) +
      (parseFloat(m.curCSS(a[0], "paddingRight", true)) || 0)
    );
  }
  function ic(a) {
    return (
      (parseFloat(m.curCSS(a[0], "marginLeft", true)) || 0) +
      (parseFloat(m.curCSS(a[0], "marginRight", true)) || 0)
    );
  }
  function hc(a) {
    return (
      (parseFloat(m.curCSS(a[0], "borderLeftWidth", true)) || 0) +
  ...
  function jc(a) {
    return (
      (parseFloat(m.curCSS(a[0], "paddingTop", true)) || 0) +
      (parseFloat(m.curCSS(a[0], "paddingBottom", true)) || 0)
    );
  }
  function Fb(a) {
    return (
      (parseFloat(m.curCSS(a[0], "marginTop", true)) || 0) +
      (parseFloat(m.curCSS(a[0], "marginBottom", true)) || 0)
    );
  }
  function kc(a) {
    return (
      (parseFloat(m.curCSS(a[0], "borderTopWidth", true)) || 0) +
  ...
  function sb(a, b, e) {
    ...
    function g(w, I) {
      ...
      y(E);
      Y = m("<div style='position:absolute;z-index:8;top:0;left:0'/>").appendTo(
        a
      );
    }
    function l(w) {
      ...
      E.each(function (wa, Ga) {
        ...
        aa = ca(wa);
        aa.getMonth() == R
          ? ea.removeClass("fc-other-month")
          : ea.addClass("fc-other-month");
        +aa == +V
          ? ea.addClass(la + "-state-highlight fc-today")
          : ea.removeClass(la + "-state-highlight fc-today");
  ...
  function Rb(a, b, e) {
    ...
    function g() {
      ...
      R = m("<div style='position:absolute;z-index:8;top:0;left:0'/>").appendTo(
        I
      );
      x =
    ...
    function fa(h) {
      if (!i("selectable")) {
        var O = Math.min(
            Ba - 1,
            Math.floor((h.pageX - v.offset().left - Ma) / db)
          ),
          x = ua(O),
      ...
      if (h.which == 1 && i("selectable")) {
        ...
        Ra.start(function (x, A) {
          ...
          if (x && x.col == A.col && !pa(x)) {
            ...
            O = [
              A,
              xa(N(A), i("slotMinutes")),
              x,
              xa(N(x), i("slotMinutes")),
            ].sort(Gb);
            c(O[0], O[3]);
          } else O = null;
        }, h);
    ...
    function X(h, O) {
      Ra.start(function (x) {
        B();
        if (x)
          if (pa(x)) ga(x.row, x.col, x.row, x.col);
          else {
            x = ma(x);
      ...
      for (v = 0; v < F; v++) {
        ...
        if (I === false) $.remove();
          ...
          if (I && I !== true) {
            $.remove();
            $ = m(I)
              .css({ position: "absolute", top: r.top, left: r.left })
              .appendTo(ea);
          }
          r.element = $;
          if (J._id === s) t(J, $, r);
      ...
      s.draggable({
                      ...
                      Eb(
                        ...
                        ia *
                          Math.round(
                            (o.end
                              ? (o.end - o.start) / wc
                              : u("defaultEventMinutes")) / u("slotMinutes")
                          )
                      );
        ...
        stop: function ($, w) {
          ...
          if (J) {
            ...
            M ||
              (I =
                Math.round((s.offset().top - X().offset().top) / ia) *
                  u("slotMinutes") +
                la -
        ...
        resize: function (M, k) {
          ...
          if (F != r) {
            v.text(
              W(
                o.start,
                !F && !o.end ? null : xa(ra(o), u("slotMinutes") * F),
                u("timeFormat")
              )
            );
            r = F;
  ...
  function Kb(a, b, e) {
    ...
    function f(G, p) {
      return b.trigger.apply(
        b,
        [G, p || da].concat(Array.prototype.slice.call(arguments, 2), [da])
      );
    }
    function g(G) {
    ...
    function q(G, p) {
      p.click(function (L) {
        if (
          !p.hasClass("ui-draggable-dragging") &&
  ...
  m.fn.fullCalendar = function (a) {
    ...
    a = m.extend(
      ...
      {},
      Ya,
      a.isRTL || (a.isRTL === oa && Ya.isRTL) ? xc : {},
      a
    );
